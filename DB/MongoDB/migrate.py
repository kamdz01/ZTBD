...
DATABASE_URL = "mongodb://admin:admin@localhost:27017/ecommerce?authSource=admin&directConnection=true"
...
def process_csv_file(file_path, collection_name):
    with open(file_path, newline="", encoding="utf-8") as csvfile:
        ...
        if data:
            ...
            print(
                f"Wstawiono {len(result.inserted_ids)} rekordów do kolekcji {collection_name}."
            )
